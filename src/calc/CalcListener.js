...
export default class CalcListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by CalcParser#exprStat.
	enterExprStat(ctx) {
	}

	// Exit a parse tree produced by CalcParser#exprStat.
	exitExprStat(ctx) {
	}
